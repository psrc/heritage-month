...
map <- ggplot()+geom_sf(data = seattle_redlining, aes(fill=holc_grade))+scale_fill_brewer(palette="Reds")+geom_point(data=tract_data, aes(x=intptlon,y=intptlat,size=estimate, alpha=.001))+coord_sf(xlim=c(-122.445, -122.2), ylim=c(47.5,47.7), crs =4326)
