...
What are the educational attainment levels for Black people? \* B15002
educational attainment

What are the poverty rates for Black people? \* B17001 B19001
...
poverty_df_black_white<- merge(poverty_df_white, poverty_df_black, on='name')
...
white_Black_df<-rbind(white_transport_df, Black_transport_df)%>%filter(name=='Region')
