...
library(dplyr)
library(tidyverse)
aian_tract<- combine %>% select(c('TRACT','COUNTY','GEOID','P0010001','P0010005', 'P0010012','P0010016', 'P0010020', 'P0010022', 'P0010027','P0010031',
                                  'P0010032',
                                  'P0010033',
                                  'P0010037',
                                  'P0010038',
...
write.csv(aian_tract,'C:\\Users\\SChildress\\Documents\\GitHub\\heritage-month\\data\\aian_2020_tract.csv')
